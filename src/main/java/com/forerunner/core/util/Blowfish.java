...
public class Blowfish{
    ...
    private static final String DEFAULT_KEY = "vNMWRMCjDpGDc0x";
    ...
    /**
     * 创建一个新对象使用指定键河豚（超大的密码将被削减）。
     *
     * @param 密码密码（视为一个真正的Unicode数组）
     */
    ...
    /**
     * 加密字符串（处理Unicode）使用标准的Java随机数发生器，这是不是伟大的创建IVS
     *
     * @param splaintext字符串加密
     * @return 加密字符串binhex格式
     */
    ...
    /**
     * 解密hexbin字符串（处理是区分大小写的）
     * @param sciphertext hexbin字符串to decrypt
     * @return 解密字符串（不等于错误）
     */
	...
	public static String encryptPwd(String password){
		...
		return bf.encryptString(password);
	}
	
	//测试
//	public static void main(String[] args){
//		String pwd = "admin123";
//		Blowfish bf = new Blowfish("X1C4R9TE57oEw2v");
//		pwd = bf.encryptString(pwd);
